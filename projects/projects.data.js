...
const PROJECTS = [
  ...
  },
  {
    ...
    story: `
      <p>School project x2</p>
      <div class="modal-story-media">
        <img src="assets/projects/connecting_people.jpg" alt="Connecting people" />
      </div>
      <p><em>When the right people connect, problems become oppoturnity.</em></p>
      <p>I created this project to solve my own problem and others’ by connecting people and helping them find suitable partners.</p>
      <p>Not a very great implementation or impactful project, so I’ll let the repository do the talking.</p>
      `,
    images: [],
  ...
  },
  {
    ...
    featured: false,
    year: "2026",
    title: "SPARK-v2 - Smart Pathway Advisor with Reasoning and Knowledge",
    emoji: "📊",
    image: "assets/projects/agents_workflow.jpg",
    tech: [
      "Python backend (Flask / FastAPI)",
    ],
    story: `
      <p>Research project x3</p>
      <p></p>
      `,
    images: [],
    link: "https://github.com/minh-quan2811/SPARK-v2",
  },
];